    ...
    return (      
      <div>
        ...
        <Switch>
          ...
          <PropsRoute path="/me/collections" exact component={CollectionsBrowser} $={this.props.jQuery} globalWindow={this.props.globalWindow} user={this.state.user} browsePrivate={true}/>
